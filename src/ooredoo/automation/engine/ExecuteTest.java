...
public class ExecuteTest {
	...
	public  void executeTest(String keyword, String object, String data, AppiumDriver<WebElement> driver,
		...
		case "FIND_BY_ID":
			...
			try {
				AndroidElement ex=null;
				//System.out.println("called FIND_BY_ID");
				ex = (AndroidElement) driver.findElement(By.id(p.getProperty(object)));
				//System.out.println("text..."+ex.getText());
				if(ex.getText().equals(data))
				{
					reportManager.pass(null, Tc_Desc);
				}
				else
		...
		case "FIND_BY_XPATH":
			...
			try {
				AndroidElement ex=null;
				//System.out.println("called FIND_BY_XPATH");
				ex = (AndroidElement) driver.findElement(By.xpath(p.getProperty(object)));
				//System.out.println("text..."+ex.getText());
				if(ex.getText().equals(data))
				{
					reportManager.pass(null, Tc_Desc);
			...
			break;
		case "FIND_BY_UIAUTOMATOR":
			
			try {
				AndroidElement ex=null;
				//System.out.println("called FIND_BY_MOBILEBY");
				ex = (AndroidElement) driver.findElement(MobileBy.AndroidUIAutomator("new UiSelector().resourceId(\""+p.getProperty(object)+"\")"));
				System.out.println("text..."+ex.getText());
				if(ex.getText().equals(data))
				{
					reportManager.pass(null, Tc_Desc);
